...
export interface IDoctorLayout extends React.ComponentPropsWithoutRef<"div"> {
  justify?: "items-center" | "items-start"
}

const sidebars: ItemSidebar[] = [
  {
    icon: (
      <>
        <svg
...
const DoctorLayout: React.FC<IDoctorLayout> = ({ children, ...divProps }) => {
  return (
    <>

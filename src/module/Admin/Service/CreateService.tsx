...
const CreateService = ({ service, mode = "create" }: Props) => {
    ...
    const handleChange = (event: SelectChangeEvent<string>) => {
        ...
        setValue("specialization", specializations.data?.data.data.filter(spe => spe.specializationID === value)[0] as Specialization)
    }
    return (
                ...
                <div className="flex flex-col justify-start mb-3">
                    <div className="flex flex-col space-y-5">
                        <FormControl>
                            ...
                            <FormHelperText error>{errors.specialization?.specializationID?.message}</FormHelperText>
                        </FormControl>
                    </div>
                </div>

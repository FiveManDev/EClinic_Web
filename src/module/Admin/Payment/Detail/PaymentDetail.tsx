...
import { useGetPaymentByIDQuery, useRefundTransactionMutation } from "hooks/query/payment/usePayment"
...
const PaymentDetail = () => {
    ...
    const { data } = useGetPaymentByIDQuery(
    ...
    return (
        <>
            ...
            <h3 className="text-xl font-medium text-black2 m-3">Payment Detail</h3>
            <div className="grid grid-cols-8 gap-6 m-3 mt-1 mr-7" >
                <div className="col-span-8 background-primary">
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <div className="flex items-center space-x-2">
                                <div className="relative w-10 h-10 overflow-hidden rounded-full">
                                    <ImageCustom
                                        src={payment?.author.avatar || "/images/avatars/avatar_1.jpg"}
                                        fill
                                        alt="user-avatar"
                                ...
                                <div className="flex flex-col">
                                    <span className="text-sm font-medium text-h1">
                                        {combineName(payment?.author.firstName, payment?.author.lastName)}
                                    </span>
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Payment ID</span>
                            <CustomInput
                                size="medium"
                                name="id"
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Payment Amount</span>
                            <CustomInput
                                name="amount"
                                size="medium"
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Payment Time</span>
                            <CustomInput
                                name="time"
                                size="medium"
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Payment Type</span>
                            <CustomInput
                                name="payment"
                                size="medium"
                    ...
                    {!payment?.isRefund && (
                        <>
                            <div className="flex flex-col justify-start mb-3">
                                <div className="flex flex-col space-y-1">
                                    <span className="text-sm font-medium text-black2">Refund Type</span>
                                    <InputCustom
                            ...
                            <CustomButton
                                ...
                                isLoading={
                                    refundTransactionMutation.isLoading
                                }

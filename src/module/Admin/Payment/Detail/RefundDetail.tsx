...
const RefundDetail = () => {
    ...
    const { data } = useGetRefundByIDQuery(
    ...
    return (
        <>
            ...
            <h3 className="text-xl font-medium text-black2 m-3">Refund Detail</h3>
                ...
                <div className="col-span-8 background-primary">
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Refund ID</span>
                            <CustomInput
                                size="medium"
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Refund Amount</span>
                            <CustomInput
                                size="medium"
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Refund Time</span>
                            <CustomInput
                                size="medium"
                                value={getCurrentDate(refund?.refundTime)}
                                disabled
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-start mb-3">
                        <div className="flex flex-col space-y-1">
                            <span className="text-sm font-medium text-black2">Refund Reason</span>
                            <CustomInput
                                size="medium"

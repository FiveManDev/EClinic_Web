    ...
    <div
      ...
      <div >
        <div className="flex justify-between w-full mb-2">
          <div className="flex items-center"><svg className="mr-1"
            width={17}
            height={16}
            viewBox="0 0 17 16"
            fill="none"
          ...
          >
            ...
            <span> {(servicePackage?.price || 0) * (1 - ((servicePackage?.discount || 1) / 100))} VND</span></div>

          <div className="flex items-center line-through"><svg className="mr-1"
            width={17}
            height={16}
            viewBox="0 0 17 16"
            fill="none"
          ...
          >
            ...
            <span className="opacity-40"> {servicePackage?.price} VND</span></div>
        </div>
      </div>
    </div>
  )

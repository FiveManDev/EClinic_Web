...
const CardService = () => {
  return (
    <div className="rounded-xl bg-white shadow-[16px_16px_24px_rgba(23,_23,_37,_0.08)]">
      <div className="relative w-full h-[140px]">
        <Image src={"/images/sample-2.png"} fill alt="service" />
      </div>
      <div className="px-[18px] py-3">
        <h4 className="text-lg font-semibold text-h1 line-clamp-2">
        ...
        <div className="flex items-center justify-between mt-4">
          <CustomButton kind="primary" size="small" className="h-10">
            Chi tiết
          </CustomButton>
          <div className="flex items-center gap-x-1">
            <svg
